...
function getHour() {
    t = new Date();
    document.getElementById("hora").innerHTML = (t.getHours() + ":" + t.getMinutes());
...
function setCorrectMargin(){
    ...
    var error = document.getElementById("error");
        ...
        if (x.matches) { 
            ...
            if(snr.innerHTML < 10){
                snr.style.marginLeft = "2.6vw";
            }else{
                snr.style.marginLeft = "1.8vw";
        
            }
            if(humr.innerHTML < 10){
                humr.style.marginLeft = "2.6vw";
            }else{
                humr.style.marginLeft = "1.8vw";
            }
            if(vientor.innerHTML < 10){
                vientor.style.marginLeft = "2.6vw";
            }else{
                vientor.style.marginLeft = "1vw";
        
            }
            if(visibr.innerHTML < 10){
                visibr.style.marginLeft = "2.6vw";
            }else{
